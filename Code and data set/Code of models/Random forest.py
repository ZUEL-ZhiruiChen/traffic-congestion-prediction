...
forest = RandomForestClassifier(n_estimators=10,
                                ...
                                random_state=1,
                                n_jobs=-1)
forest.fit(train_x1, train_y)
pred_y = forest.predict_proba(test_x1)
print(sklearn.metrics.classification_report(test_y,pred_y.argmax(1),digits=6))
sklearn.metrics.roc_auc_score(test_y,pred_y,average='weighted',multi_class='ovo')